...
class ColectiveSociety {
	private $config = '{"title":"Datos de la sociedad","description":"Informaci\u00f3n de las sociedad colectiva","prefix":"asipi_colective_society_","domain":"asipi_colective_society","class_name":"ColectiveSociety","post-type":["post"],"context":"normal","priority":"default","cpt":"colective_society","fields":[{"type":"text","label":"Nombre SGC*","id":"asipi_colective_society_nombre-sgc"},{"type":"textarea","label":"Materia que atiende esa sociedad de gesti\u00f3n","id":"asipi_colective_society_materia-que-atiende-esa-sociedad-de-gestion"},{"type":"text","label":"Direcci\u00f3n f\u00edsica","id":"asipi_colective_society_direccion-fisica"},{"type":"tel","label":"Tel\u00e9fono*","pattern":"\/^\\\\\\\\(?([0-9]{3})\\\\\\\\)?[-.\\\\\\\\s]?([0-9]{3})[-.\\\\\\\\s]?([0-9]{4})$\/","id":"asipi_colective_society_telefono"},{"type":"text","label":"Sitio Web*","id":"asipi_colective_society_sitio-web"},{"type":"email","label":"Mail de contacto*","id":"asipi_colective_society_mail-de-contacto"}]}';
